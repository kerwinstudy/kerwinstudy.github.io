        ...
        <form id="userForm" name="userForm" method="post" action="${pageContext.request.contextPath }/jsp/user.do">
            ...
            <div>
			 ...
			 <div>
                    ...
                    <input type="text" name="userName" id="userName" value="${user.usersName }">
					<font color="red"></font>
             </div>
<%--            <div>--%>
<%--                <label for="userLevel">用户等级：</label>--%>
<%--                <input type="number" name="userLevel" id="userLevel" value="${user.userLevel }">--%>
<%--                <font color="red"></font>--%>
<%--            </div>--%>
            <div>
...
<%--                    <label >用户角色：</label>--%>
<%--                    <!-- 列出所有的角色分类 -->--%>
<%--					<input type="hidden" value="${user.UserLevel }" id="rid" />--%>
